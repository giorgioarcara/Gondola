function ResTable = writeGTstructMat(GTstruct, opt)
    arguments
        GTstruct (1,:) struct
...
%% writeGTstructMat (GTstruct, 'ResMat', {value}, 'p_mats', {value}, 'Fields', {value}, 'NodeLabels', {value}, 'OtherNodeLabels', {values}, 'FileName', 'value')
%
