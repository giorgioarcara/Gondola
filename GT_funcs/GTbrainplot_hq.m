%% GTbrainplot_hq(GTres, nodefield, edgefield, labelfields, Coords, n_cols, node_multi, brainpath, cmap, labels)
%
...
function GTbrainplot_hq(GTres, nodefield, edgefield, labelfields, Coords, n_cols, node_multi, brainpath, cmap, labels)
