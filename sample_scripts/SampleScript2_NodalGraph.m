...
% Compute nodal graph indices - Node Degree
GTstruct_AllNetworks = GTmeasure(GTstruct_AllNetworks, ...
    'Field', 'mat_bin', ...
    'MeasureFunc','degrees_und', ...
    'MeasureName','NodeDegree')

% Compute nodal graph indices - betweenness
GTstruct_AllNetworks = GTmeasure(GTstruct_AllNetworks, ...
    "Field",'mat_bin', ...
    'MeasureFunc', 'betweenness_bin', ...
    'MeasureName', 'Betweenness')
...
% Plot GT measures (THESE NETWORKS ARE BAD, CONSIDER HAVING BETTER DATA)
GTbrainplot(GTstruct_AllNetworks, ...
    'PlotTitle', titles, ...
    'NodeField', 'NodeDegree', ...
    'EdgeField', 'mat_bin', ...
...
ResTable = writeGTresNode(GTstruct_AllNetworks, ...
    "Fields", {'NodeDegree', 'Betweenness'}, ...
    'OtherFields',{'ID', 'Condition', 'FCMeasure', 'FreqBand'}, ...
    'NodeLabels',AllUsedScouts, ...
    'FileName', fullfile(files_dir, 'risultati'))